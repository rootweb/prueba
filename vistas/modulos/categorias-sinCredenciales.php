	...
	<div class="container">
		...
		if(isset($mostrarCursos->detail) && $mostrarCursos->detail != ""){
			...
			echo '<div class="container" style="position:relative">
				...
				echo '<a href="https://www.udemy.com/courses/'.$traerCategoria[0]["ruta"].'" target="_blank" class="btn btn-success btn-lg text-uppercase fondoUdemy">
...
<script type="application/ld+json">
{
  ...
  for($i = 0; $i <count($mostrarCursos->results)-1; $i++){
  	...
  	echo '{
	      ...
	      "item": {
	        "@type": "Course",
	        "url": "'.$url.$idioma.'/'.$traerCategoria[0]["ruta"].'",
