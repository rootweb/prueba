	...
	<div class="container">
		...
		if(isset($mostrarCursos->detail) && $mostrarCursos->detail != "" || count($mostrarCursos->results)== 0){
			...
			if($traerSubcategoria[0]["gratis"] == 1){
				...
				echo '<a href="https://click.linksynergy.com/deeplink?id='.$afiliado["id"].'&mid='.$afiliado["mid"].'&murl=https%3A%2F%2Fwww.udemy.com%2Fcourses%2F'.$traerCategoria[0]["ruta"].'%2Fall-courses%2F%3Fprice=price-free%26persist_locale%26locale%3D'.$idioma.'" target="_blank" class="btn btn-success btn-lg text-uppercase fondoUdemy">';

			}else{

				echo '<a href="https://click.linksynergy.com/deeplink?id='.$afiliado["id"].'&mid='.$afiliado["mid"].'&murl=https%3A%2F%2Fwww.udemy.com%2Fcourses%2F'.$traerCategoria[0]["ruta"].'%2F'.$traerSubcategoria[0]["ruta"].'%2F%3Fpersist_locale%26locale%3D'.$idioma.'" target="_blank" class="btn btn-success btn-lg text-uppercase fondoUdemy">';
