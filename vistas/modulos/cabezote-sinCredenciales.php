	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-12 col-sm-9 col-lg-5 pl-sm-4 pt-3">
				...
				<div class="input-group mb-3">
					...
					<div class="input-group-append">
				  	...
				  	<input type="text" class="form-control buscador" placeholder="<?php echo ControladorTraductor::ctrTraducir($idioma, "Buscar cursos"); ?>">
			...
			<div class="d-none d-lg-block col-lg-2 pt-lg-4" style="margin-top:-20px">
				...
				<!-- <a href="<?php echo "https://click. linksynergy. com/fs-bin/click?id=".$afiliado["id"]."&offerid=".$afiliado["offerid"].".81&type=3&subid=0";?>" target="_blank"> -->
 
				<a href="https://www.udemy.com/" target="_blank">

					<small class="text-light" style="margin-left:25px">
					<?php echo ControladorTraductor::ctrTraducir($idioma, "Marca afiliada a"); ?>
					
					</small>
					<img src="<?php echo $url."vistas/img/plantilla/udemy.png" ?>">
			...
			<div class="fixed-bottom bg-dark d-lg-none text-center pt-2 row">
				...
				<ul class="list-inline col-12 col-sm-6 mb-0">
					...
					<li class="list-inline-item">
						...
						<a href="https://www.facebook.com/coursefreeonline" target="_blank">
					...
					<li class="list-inline-item">
						...
						<a href="https://www.twitter.com/FranklynZarate" target="_blank">
					...
					<li class="list-inline-item">
						...
						<a href="https://www.linkedin.com/franklyn-alex-zárate-jáuregui-4770a3140" target="_blank">
