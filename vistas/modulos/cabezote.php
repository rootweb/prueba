			...
			<div class="d-none d-lg-block col-lg-2 pt-lg-4" style="margin-top:-20px">
				...
				<?php
					...
					if($afiliado["id"] != ""){
						...
						echo '<a href="https://click.linksynergy.com/fs-bin/click?id='.$afiliado["id"].'&offerid='.$afiliado["offerid"].'.81&type=3&subid=0" target="_blank">';

					}else{

						echo '<a href="https://www.udemy.com" target="_blank">';
